...
def train(workspace):
    logging.info("Starting training with OU modulator")
    ...
    slippery_modulator = modulators.OUDrift(mu=0.15, theta=0.001, sigma=0.1, low=0.0, high=cfg.domain.slippery_prob, seed=cfg.env.seed)
