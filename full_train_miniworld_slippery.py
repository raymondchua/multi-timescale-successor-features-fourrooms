...
def train(workspace):
    ...
    for task_idx in tqdm(range(num_tasks_in_total)):
        ...
        for _ in range(num_epochs):
            train_seq = training_loop_slippery_fix.run_loop_slippery(
                agent=train_agent,
            ...
            eval_seq = eval_loop_slippery_fix.run_loop_slippery(
            ...
            eval_stats["slip_prob"] = slippery_modulator.sample(
                workspace.global_step_train
            )
